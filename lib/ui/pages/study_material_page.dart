...
class StudyMaterialPage extends StatelessWidget with NavigationStates {
  final Function onMenuTap;

  const StudyMaterialPage({Key key, this.onMenuTap}) : super(key: key);
                  ...
                  child: Row(
                    ...
                    children: [
                      InkWell(
                        ...
                        onTap: StudyMaterialPage().onMenuTap,
                      ),
                      Padding(
