...
import 'package:solvecaseflutter/menu_dashboard_layout/dashboard.dart';
...
class _MenuDashboardLayoutState extends State<MenuDashboardLayout>
  ...
  int findSelectedIndex(NavigationStates navigationState) {
    if (navigationState is DownloadsPage) {
      return 0;
    } else if (navigationState is VideoLecturesPage) {
      return 1;
    } else if (navigationState is StudyMaterialPage) {
      return 2;
    } else if (navigationState is TopContributorsPage) {
      return 3;
    } else if (navigationState is SharePage) {
      return 4;
    } else if (navigationState is ContactUsPage) {
      return 5;
    } else if (navigationState is DevelopedByPage) {
      return 6;
    } else {
      return 0;
    }
